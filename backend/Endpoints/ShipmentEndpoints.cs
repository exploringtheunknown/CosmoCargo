...
{
    [Required] public LocationDto Origin { get; set; } = new();

    [Required] public LocationDto Destination { get; set; } = new();

    [Required] [Range(0.01, 100000)] public decimal Weight { get; set; }
...
{
    [Required] public Guid PilotId { get; set; }
}