...
namespace CosmoCargo.Migrations
{
    ...
    [Migration("20250507085456_AddCustomsDeclaration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CosmoCargo.Model.CustomsDeclaration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<bool>("ContainsLifeforms")
                        .HasColumnType("boolean")
                        .HasColumnName("contains_lifeforms");

                    b.Property<string>("CustomsNotes")
                        .HasColumnType("text")
                        .HasColumnName("customs_notes");

                    b.Property<bool>("IsPlasmaActive")
                        .HasColumnType("boolean")
                        .HasColumnName("is_plasma_active");

                    b.Property<string>("LifeformType")
                        .HasColumnType("text")
                        .HasColumnName("lifeform_type");

                    b.Property<bool>("OriginPlanetLawsConfirmed")
                        .HasColumnType("boolean")
                        .HasColumnName("origin_planet_laws_confirmed");

                    b.Property<int?>("PlasmaStabilityLevel")
                        .HasColumnType("integer")
                        .HasColumnName("plasma_stability_level");

                    b.Property<bool>("QuarantineRequired")
                        .HasColumnType("boolean")
                        .HasColumnName("quarantine_required");
                    ...
                    b.HasKey("Id")
                        .HasName("p_k_customs_declarations");

                    b.HasIndex("ShipmentId")
                        .IsUnique()
                        .HasDatabaseName("i_x_customs_declarations_shipment_id");

                    b.ToTable("customs_declarations");
                });
            ...
            modelBuilder.Entity("CosmoCargo.Model.CustomsDeclaration", b =>
                {
                    b.HasOne("CosmoCargo.Model.Shipment", "Shipment")
                        ...
                        .HasForeignKey("CosmoCargo.Model.CustomsDeclaration", "ShipmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("f_k_customs_declarations__shipments_shipment_id");
